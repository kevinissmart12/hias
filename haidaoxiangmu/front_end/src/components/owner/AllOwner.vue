<template>
    <div class="allowner">
        ...
        <transition name="el-fade-in-linear">
                    <div class="bg" v-show="formShow">

                        <el-card class="box-card">
                            <div slot="header" class="clearfix">
                                <span v-if="checkOrAdd=='check'">{{form.discriminator+'养殖'}}</span>
                                <span v-else>添加养殖</span>
                                <el-button style="float: right; padding: 3px 0" @click="cancle" type="text">关闭</el-button>
                            </div>
                            <!-- form -->
